...
CREATE TABLE IF NOT EXISTS `pizzeria`.`client` (
  ...
  `codi_postal` INT(5) ZEROFILL NULL,
  `telefon` INT(13) NULL,
  `localitat_id` INT(4) NULL,
...
CREATE TABLE IF NOT EXISTS `pizzeria`.`comanda` (
  ...
  `quantitat_pizzes` INT(3) NULL,
  `quantitat_hamburgueses` INT(3) NULL,
  `quantitat_begudes` INT(3) NULL,
  `preu_total` FLOAT(6,2) NOT NULL,
...
INSERT INTO `comanda` (`data_hora`, `tipus`, `quantitat_pizzes`, `quantitat_hamburgueses`, `quantitat_begudes`, `preu_total`, `client_id`, `empleat_id`)
VALUES ('2022-07-08 17:39:02', 'domicili', 2, 3, 5, 75.98, 1, 2);
INSERT INTO `comanda` (`data_hora`, `tipus`, `quantitat_pizzes`, `quantitat_hamburgueses`, `quantitat_begudes`, `preu_total`, `client_id`, `empleat_id`)
VALUES ('2022-07-06 12:39:02', 'domicili', 1, 2, 1, 45.76, 2, 2);
INSERT INTO `comanda` (`data_hora`, `tipus`, `quantitat_pizzes`, `quantitat_hamburgueses`, `quantitat_begudes`, `preu_total`, `client_id`, `empleat_id`)
VALUES ('2022-07-05 09:39:02', 'domicili', 3, 4, 7, 123.75, 2, 3);
INSERT INTO `comanda` (`data_hora`, `tipus`, `quantitat_pizzes`, `quantitat_hamburgueses`, `quantitat_begudes`, `preu_total`, `client_id`, `empleat_id`)
VALUES ('2022-07-05 09:39:02', 'botiga', 2, 3, 1, 76.97, 1, 1);
INSERT INTO `comanda` (`data_hora`, `tipus`, `quantitat_pizzes`, `quantitat_hamburgueses`, `quantitat_begudes`, `preu_total`, `client_id`, `empleat_id`)
VALUES ('2022-07-05 09:39:02', 'domicili', 2, 1, 8, 96.34, 4, 5);
INSERT INTO `comanda` (`data_hora`, `tipus`, `quantitat_pizzes`, `quantitat_hamburgueses`, `quantitat_begudes`, `preu_total`, `client_id`, `empleat_id`)
VALUES ('2022-07-05 09:39:02', 'domicili', 0, 4, 2, 87.23, 4, 5);
